...
#PBS -j oe
#PBS -q workq
#PBS -o /lustre/scratch/users/$USER/tfbs-matching/log/shuffeling/shuffeling_^array_index^.log
...
pbs_mapping_file=$script_dir/utils/seeds.txt

bed_file=$granges_files/open_chrom_embryo.bed
